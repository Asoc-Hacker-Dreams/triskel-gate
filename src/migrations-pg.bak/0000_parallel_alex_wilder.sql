...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "invoices_organizer_idx" ON "invoices" ("organizer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "invoices_event_idx" ON "invoices" ("event_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "invoices_status_idx" ON "invoices" ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "invoices_period_idx" ON "invoices" ("period_start","period_end");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "orders_email_idx" ON "orders" ("customer_email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "orders_status_idx" ON "orders" ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "orders_order_number_idx" ON "orders" ("order_number");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "platform_fees_event_idx" ON "platform_fees" ("event_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "platform_fees_order_idx" ON "platform_fees" ("order_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "platform_fees_status_idx" ON "platform_fees" ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sales_stats_event_date_idx" ON "sales_stats" ("event_id","date");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "subscriptions_organizer_idx" ON "subscriptions" ("organizer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "subscriptions_stripe_sub_idx" ON "subscriptions" ("stripe_subscription_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tickets_uuid_idx" ON "tickets" ("uuid");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tickets_qr_code_idx" ON "tickets" ("qr_code");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tickets_ticket_number_idx" ON "tickets" ("ticket_number");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tickets_order_idx" ON "tickets" ("order_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tickets_used_idx" ON "tickets" ("is_used");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tickets_event_idx" ON "tickets" ("event_id");--> statement-breakpoint
DO $$ BEGIN
